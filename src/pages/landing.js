...
import ComposeMusicImage from "-!svg-react-loader!../images/compose_music.inline.svg"
import MoreMusicImage from "-!svg-react-loader!../images/more_music.svg"
...
const LandingPage = ({ data, location }) => {
        ...
        <div className="container max-w-5xl mx-auto m-8">
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full sm:w-1/2 p-6">
              <ComposeMusicImage className={"w-full sm:h-64 mx-auto"} />
            </div>
          </div>
        ...
        <div className="container mx-auto px-2 pt-4 pb-12 text-gray-800">
          ...
          <div className="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
            ...
            <div className="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
              ...
              <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                <div className="w-full pt-6 text-3xl text-gray-600 font-bold text-center">£0 <span
                  className="text-base">for one user</span></div>
                <div className="flex items-center justify-center">
                  <button
                    className="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg">Sign
                    Up
                  </button>
                </div>
              </div>
            ...
            <div
              ...
              <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                <div className="w-full pt-6 text-4xl font-bold text-center">£x.99 <span
                  className="text-base">/ per user</span></div>
                <div className="flex items-center justify-center">
                  <button
                    className="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg">Sign
                    Up
  ...
  opacity="0.200000003"/>
      ...
      <section className="container mx-auto text-center py-6 mb-12">
        ...
        <button
          className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg">Action!
        </button>
        ...
        <div className="container mx-auto  px-8">
          ...
          <div className="w-full flex flex-col md:flex-row py-6">
            ...
            <div className="flex-1">
              ...
              <ul className="list-reset mb-6">
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a href="#" className="no-underline hover:underline text-gray-800 hover:text-orange-500">Official
                    Blog</a>
                </li>
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
