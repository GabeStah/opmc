...
export default class Nav extends Component {
  render () {
    return <nav id="header" className="fixed w-full z-30 top-0 text-white gradient">
      <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div className="pl-4 flex items-center">
          <a className="toggleColour text-gray-800 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
             href="/">
        ...
        <div
          ...
          <button className={'bg-white text-gray-800 hover:bg-gray-400 hover:text-white'} id="navAction">Contact Us</button>
        </div>
      </div>
