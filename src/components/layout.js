...
const Layout = ({ children }) => {
  ...
  // TODO: https://blogs.perficient.com/2017/12/19/how-to-customize-your-own-html5-audio-player/
  // TODO: https://www.tailwindtoolbox.com/starter-components
      ...
      >
        ...
        <div className="w-full">
          ...
          <div className="flex items-center justify-center h-screen bg-red-lightest">
            <div className="bg-white shadow-lg rounded-lg w-auto">
              <div className="flex">
                <div>
                  <img className="w-full rounded hidden md:block" src="https://tailwindcss.com/img/card-top.jpg"
                       alt="Album Pic" />
                </div>
        ...
        <footer>
          © {new Date().getFullYear()} Gabe Wyatt, Built with
          {` `}
